...
# -----------------------------------------------------------
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=30),   # Токен доступа живёт 30 минут
    'REFRESH_TOKEN_LIFETIME': timedelta(days=7),       # Токен обновления живёт 7 дней
    'ROTATE_REFRESH_TOKENS': True,                     # Выдавать новый refresh при обновлении
    'BLACKLIST_AFTER_ROTATION': True,                  # Старый refresh блокировать после обновления
